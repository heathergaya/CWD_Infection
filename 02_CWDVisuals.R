...
# Plot Figure 3 ####
BigOut_133 <- readRDS('LargePosterior_133.rds')
plotsurvs <- BigOut_133[[1]]
plotme <- BigOut_133[[2]]
...
### **Figure 3 B.1 ####
BigOut_31 <- readRDS('LargePosterior_31.rds')
plotsurvs2 <- BigOut_31[[1]]
plotme2 <- BigOut_31[[2]]
